...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40637 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40637(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40641 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40641(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40648 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40648(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40650 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40650(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40656 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40656(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40663 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40663(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40666 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40666(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40676 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40676(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40692 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40692(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40699 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40699(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40706 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40706(b);
}
});
