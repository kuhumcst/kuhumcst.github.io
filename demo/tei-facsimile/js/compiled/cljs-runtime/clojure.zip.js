...
var G__49219 = clojure.zip.node(loc);
var fexpr__49218 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__49218.cljs$core$IFn$_invoke$arity$1 ? fexpr__49218.cljs$core$IFn$_invoke$arity$1(G__49219) : fexpr__49218.call(null,G__49219));
});
/**
...
var G__49221 = clojure.zip.node(loc);
var fexpr__49220 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__49220.cljs$core$IFn$_invoke$arity$1 ? fexpr__49220.cljs$core$IFn$_invoke$arity$1(G__49221) : fexpr__49220.call(null,G__49221));
} else {
...
var fexpr__49222 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__49222.cljs$core$IFn$_invoke$arity$2 ? fexpr__49222.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__49222.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__49234 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49234,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49234,(1),null);
var vec__49237 = clojure.zip.children(loc);
...
var vec__49269 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49268__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__49313 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49313,(0),null);
var map__49316 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49313,(1),null);
var map__49316__$1 = (((((!((map__49316 == null))))?(((((map__49316.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49316.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49316):map__49316);
var path = map__49316__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49316__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49316__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49333__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__49341 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49341,(0),null);
var map__49344 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49341,(1),null);
var map__49344__$1 = (((((!((map__49344 == null))))?(((((map__49344.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49344.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49344):map__49344);
var path = map__49344__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49344__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__49351 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49351,(0),null);
var map__49354 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49351,(1),null);
var map__49354__$1 = (((((!((map__49354 == null))))?(((((map__49354.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49354.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49354):map__49354);
var path = map__49354__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49354__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__49367 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49367,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49367,(1),null);
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq49371){
var G__49372 = cljs.core.first(seq49371);
var seq49371__$1 = cljs.core.next(seq49371);
var G__49373 = cljs.core.first(seq49371__$1);
var seq49371__$2 = cljs.core.next(seq49371__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49372,G__49373,seq49371__$2);
}));
...
var G__49740 = clojure.zip.rightmost(child);
loc__$1 = G__49740;
continue;
} else {
return loc__$1;
...
var vec__49470 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49470,(0),null);
var map__49473 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49470,(1),null);
...
var path = map__49473__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49473__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49473__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49473__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49473__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__49754 = clojure.zip.rightmost(child);
loc__$1 = G__49754;
continue;
} else {
return loc__$1;
