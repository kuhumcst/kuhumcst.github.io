...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41298 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41298(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41301 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41301(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41317 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41317(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41337 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41337(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41345 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41345(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41349 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41349(reader);
}
});
...
var G__41467 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41468 = s.append(c);
c = G__41467;
s = G__41468;
continue;
}
