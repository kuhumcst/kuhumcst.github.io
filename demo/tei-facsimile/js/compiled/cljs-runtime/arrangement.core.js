...
var ys__$1 = ys;
while(true){
if(((cljs.core.seq(xs__$1)) && (cljs.core.seq(ys__$1)))){
...
if((o === (0))){
var G__50412 = cljs.core.next(xs__$1);
var G__50413 = cljs.core.next(ys__$1);
xs__$1 = G__50412;
ys__$1 = G__50413;
continue;
} else {
...
return (cljs.core.count(xs__$1) - cljs.core.count(ys__$1));
}
break;
}
});
