...
var G__48560 = o;
goog.object.set(G__48560,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__48934__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__48934 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__48935__i = 0, G__48935__a = new Array(arguments.length -  0);
while (G__48935__i < G__48935__a.length) {G__48935__a[G__48935__i] = arguments[G__48935__i + 0]; ++G__48935__i;}
  args = new cljs.core.IndexedSeq(G__48935__a,0,null);
} 
return G__48934__delegate.call(this,args);};
G__48934.cljs$lang$maxFixedArity = 0;
G__48934.cljs$lang$applyTo = (function (arglist__48939){
var args = cljs.core.seq(arglist__48939);
return G__48934__delegate(args);
});
G__48934.cljs$core$IFn$_invoke$arity$variadic = G__48934__delegate;
return G__48934;
})()
;
} else {
...
var G__48574 = o;
goog.object.set(G__48574,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__48945__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__48945 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__48946__i = 0, G__48946__a = new Array(arguments.length -  0);
while (G__48946__i < G__48946__a.length) {G__48946__a[G__48946__i] = arguments[G__48946__i + 0]; ++G__48946__i;}
  args = new cljs.core.IndexedSeq(G__48946__a,0,null);
} 
return G__48945__delegate.call(this,args);};
G__48945.cljs$lang$maxFixedArity = 0;
G__48945.cljs$lang$applyTo = (function (arglist__48947){
var args = cljs.core.seq(arglist__48947);
return G__48945__delegate(args);
});
...
var G__48591 = props;
var G__48591__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48591,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__48591);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48591__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__48591__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__48596 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48596,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__48596;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__48611){
var map__48614 = p__48611;
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48614__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__48662_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__48662_SHARP_);
}));
} else {
return null;
}
...
var vec__48745 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48745,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48745,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48745,(2),null);
...
var temp__5739__auto___49062 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___49062 == null)){
} else {
var key_49064 = temp__5739__auto___49062;
(jsprops.key = key_49064);
}
...
var temp__5739__auto___49069 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___49069 == null)){
} else {
var key_49071 = temp__5739__auto___49069;
(jsprops.key = key_49071);
}
...
var G__48815 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__48815) : reagent.impl.template.as_element.call(null,G__48815));
} else {
var temp__5739__auto___49087 = reagent.impl.template.get_key(cljs.core.meta(argv));
...
var G__48838 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__48838)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__48838)){
return x;
} else {
...
var len__4736__auto___49091 = arguments.length;
var i__4737__auto___49092 = (0);
while(true){
if((i__4737__auto___49092 < len__4736__auto___49091)){
args__4742__auto__.push((arguments[i__4737__auto___49092]));

var G__49094 = (i__4737__auto___49092 + (1));
i__4737__auto___49092 = G__49094;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq48843){
...
break;
default:
var G__49108 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__49108;
continue;
...
var ctx = ({});
var vec__48884 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48884,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48884,(1),null);
...
var G__48893 = (cljs.core.count(argv) - first_child);
switch (G__48893) {
case (0):
